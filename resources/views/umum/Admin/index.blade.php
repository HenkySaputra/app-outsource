...
@section('container')
    ...
    @include('umum.' . $backUrl . '.modal.create')
    @include('umum.' . $backUrl . '.modal.update')
    @include('umum.' . $backUrl . '.modal.delete')
    @include('umum.' . $backUrl . '.modal.detail')
    @include('umum.' . $backUrl . '.modal.dataRegis')
@endsection
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            editData();
            deleteData();
            detailData("{{ route($backUrl . '.detail', '') }}", "{{ asset('img/' . $backUrl) }}",
                '#modalDetail', "{{ asset('img/') }}");
        });
        ...
        function createData() {
            ...
            $('#createForm').submit(function(e) {
                ...
                $('#btn-submitted').removeClass('d-none');
        ...
        function editData() {
            getEditData("{{ route($backUrl . '.detail', '') }}", "{{ asset('img/' . $backUrl) }}", '#modalEdit');
